...
<head>
    ...
    <title>Sửa Thể Loại - TiệmSách</title>
...
<body>
    <div class="main-wrapper">
        <h2 style="margin-bottom: 1.5rem; font-family: var(--font-heading);">Sửa Thể Loại</h2>
        <div class="data-card">
            <form action="?area=category&act=edit&id=<?= $category['id'] ?>" method="POST">
