...
<head>
    ...
    <title>Sửa Tác Giả - TiệmSách</title>
...
<body>
    <div class="main-wrapper">
        ...
        <div class="data-card">
            <form action="?area=author&act=edit&id=<?= $author['id'] ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="bio" class="form-control" placeholder="Nhập tóm tắt tiểu sử hoặc thông tin giới thiệu về tác giả..."><?= htmlspecialchars($author['bio'] ?? '') ?></textarea>
                </div>
