...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-icon.dark { background: rgba(17,24,39,0.08); color: var(--dark); }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-section">
            ...
            <a href="?area=admin&controller=book&action=index" class="nav-item <?= (($_GET['controller'] ?? '') == 'book' || !isset($_GET['controller'])) && ($_GET['area'] ?? '') == 'admin' ? 'active' : '' ?>">
                <span class="nav-icon"><i class="fa-solid fa-book"></i></span>
                Quản lý Sách
                <span class="nav-badge">Hot</span>
            </a>
            <a href="?area=admin&controller=category&action=index" class="nav-item <?= ($_GET['controller'] ?? '') == 'category' ? 'active' : '' ?>">
                <span class="nav-icon"><i class="fa-solid fa-tags"></i></span>
                Thể loại
            </a>
            <a href="?area=admin&controller=author&action=index" class="nav-item <?= ($_GET['controller'] ?? '') == 'author' ? 'active' : '' ?>">
